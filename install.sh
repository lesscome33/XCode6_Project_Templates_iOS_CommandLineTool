...
# Default the folder name to "extra template".
folderName="extra template"
...
mkdir -p "$installDirectory"/"Command Line Tool.xctemplate/Classes/"
mkdir -p "$installDirectory"/"Command Line Tool.xctemplate/Resources/"
